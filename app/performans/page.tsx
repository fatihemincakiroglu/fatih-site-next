...
export const metadata: Metadata = {
  ...
  description: 'Trafik, dönüşüm ve büyüme hedeflerini veri odaklı yaklaşımla optimize etme.',
    ...
    <div style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh', background: '#f8f7f5' }}>
      <div style={{ background: '#1a1612', padding: '64px 32px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <span style={{ fontSize: '11px', color: 'var(--orange)', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', display: 'block', marginBottom: '16px' }}>PERFORMANS VE GROWTH</span>
          ...
          <p style={{ color: '#9a9a9a', fontSize: '17px', lineHeight: 1.7, marginBottom: '32px', maxWidth: '560px' }}>Trafik, dönüşüm ve büyüme hedeflerini veri odaklı yaklaşımla optimize etme.</p>
