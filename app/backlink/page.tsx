...
export const metadata: Metadata = {
  ...
  description: 'Editoryal linkler ve dijital PR kampanyalarıyla domain otoritesi inşası.',
    ...
    <div style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh', background: '#f8f7f5' }}>
      <div style={{ background: '#1a1612', padding: '64px 32px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <span style={{ fontSize: '11px', color: 'var(--orange)', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', display: 'block', marginBottom: '16px' }}>BACKLINK VE DIJITAL PR</span>
          ...
          <p style={{ color: '#9a9a9a', fontSize: '17px', lineHeight: 1.7, marginBottom: '32px', maxWidth: '560px' }}>Editoryal linkler ve dijital PR kampanyalarıyla domain otoritesi inşası.</p>
