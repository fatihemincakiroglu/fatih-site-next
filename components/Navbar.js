...
const getMenu = (isEn, u) => isEn ? [
  { label: 'Services', url: u.hizmetler, altlar: [
    { label: 'SEO', url: u.seo, ikon: '🔍', alt: 'Technical SEO & content optimization' },
    { label: 'Content', url: u.icerik, ikon: '✍️', alt: 'Content strategy' },
  ...
  { label: 'Resources', url: u.kaynaklar, altlar: [
    ...
    { label: 'FAQ', url: u.sss, ikon: '❓', alt: 'Frequently asked questions' },
  ]},
...
export default function Navbar() {
  ...
  return (
    <>
      <nav ref={navRef} style={{ position:'fixed', top:0, left:0, right:0, zIndex:1000, background:'#fff', height:'var(--nav-h)', display:'flex', alignItems:'center', padding:'0 24px', borderBottom:'1px solid #ede8e0', boxShadow:'0 1px 8px rgba(0,0,0,0.04)' }}>
        <div style={{ maxWidth:'var(--max-w)', margin:'0 auto', width:'100%', display:'flex', alignItems:'center' }}>
          ...
          <div className="desktop-nav" style={{ display:'flex', alignItems:'center', gap:'6px', flexShrink:0 }}>
            <Link href={trPath} locale="tr" style={{ padding:'5px 10px', borderRadius:'6px', fontSize:'12px', fontWeight:700, background:!isEn?'var(--orange)':'transparent', color:!isEn?'#fff':'#aaa', border:!isEn?'none':'1px solid #eee', fontFamily:'var(--font-body)' }}>TR</Link>
            <Link href={enPath} locale="en" style={{ padding:'5px 10px', borderRadius:'6px', fontSize:'12px', fontWeight:700, background:isEn?'var(--orange)':'transparent', color:isEn?'#fff':'#aaa', border:isEn?'none':'1px solid #eee', fontFamily:'var(--font-body)', marginRight:'6px' }}>EN</Link>
          ...
          <div className="mobile-nav" style={{ display:'none', alignItems:'center', gap:'6px', marginLeft:'auto' }}>
            <Link href={trPath} locale="tr" style={{ padding:'4px 8px', borderRadius:'5px', fontSize:'11px', fontWeight:700, background:!isEn?'var(--orange)':'#f0f0f0', color:!isEn?'#fff':'#555' }}>TR</Link>
            <Link href={enPath} locale="en" style={{ padding:'4px 8px', borderRadius:'5px', fontSize:'11px', fontWeight:700, background:isEn?'var(--orange)':'#f0f0f0', color:isEn?'#fff':'#555' }}>EN</Link>
