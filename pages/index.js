...
const HIZMET_TABS = {
  tr: [
    { id: 'seo', label: 'SEO & GEO', ikon: '🔍', aciklama: 'Temel prensibimiz; Google rehberliğinde web sitenizin en iyi SEO performansını elde etmesidir. Kapsamlı teknik denetim ve doğal büyüme stratejisiyle sürdürülebilir sonuçlar sağlıyorum.', link: '/seo-danismanligi', linkLabel: 'SEO Hizmetleri →', grafik: { oncesi: { aylik: '2.4K', keyword: '38' }, sonrasi: { aylik: '18.2K', keyword: '486', ai: '91%' } } },
    ...
    { id: 'geo', label: 'GEO & AI SEO', ikon: '🤖', aciklama: 'ChatGPT, Perplexity, Google AI Overview ve diğer yapay zekâ arama motorlarında kaynak olarak görünün. LLM optimizasyonuyla markanızı geleceğin aramalarına hazırlayın.', link: '/geo-danismanligi', linkLabel: 'GEO Hizmetleri →', grafik: { oncesi: { aylik: '800', keyword: '15' }, sonrasi: { aylik: '7.2K', keyword: '198', ai: '95%' } } },
