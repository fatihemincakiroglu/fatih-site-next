...
const TUM_YAZILAR = [
  ...
  { slug: 'core-web-vitals-2025',      kategori: 'technical', sure: 12, featured: true,
    tr: { baslik: 'Core Web Vitals 2026: LCP, INP ve CLS Optimizasyon Rehberi', ozet: 'Google\'ın sıralama sinyali olarak kullandığı üç kritik metriği nasıl iyileştirirsiniz? Adım adım rehber.' },
    en: { baslik: 'Core Web Vitals 2026: Complete LCP, INP and CLS Optimization Guide', ozet: 'How to improve the three critical metrics Google uses as ranking signals? Step-by-step guide.' },
  },
  ...
  { slug: 'anahtar-kelime-arastirmasi', kategori: 'content', sure: 13, featured: false,
    tr: { baslik: 'Anahtar Kelime Araştırması 2026: Niyetten Stratejiye', ozet: 'Arama niyetini doğru okuyan, rekabet analizi yapan ve içerik planını şekillendiren keyword araştırması.' },
    en: { baslik: 'Keyword Research 2026: From Intent to Strategy', ozet: 'Keyword research that correctly reads search intent, performs competitive analysis and shapes content plans.' },
  },
  ...
  { slug: 'backlink-stratejisi-2025',  kategori: 'backlink', sure: 13, featured: true,
    tr: { baslik: 'Backlink Stratejisi 2026: Kaliteli Link İnşasının Yeni Yolu', ozet: 'Editoryal link kazanmak, broken link building ve dijital PR\'ı birleştiren modern backlink stratejisi.' },
    en: { baslik: 'Backlink Strategy 2026: The New Way to Build Quality Links', ozet: 'Modern backlink strategy combining editorial link earning, broken link building and digital PR.' },
  },
  ...
  { slug: 'e-ticaret-seo-rehberi',     kategori: 'ecommerce', sure: 16, featured: true,
    tr: { baslik: 'E-Ticaret SEO Rehberi 2026: Kategori ve Ürün Sayfaları', ozet: 'Faceted navigation, duplicate content ve programatik içerik dahil kapsamlı e-ticaret SEO kılavuzu.' },
    en: { baslik: 'E-Commerce SEO Guide 2026: Category and Product Pages', ozet: 'Comprehensive e-commerce SEO guide including faceted navigation, duplicate content and programmatic content.' },
  },
  ...
  { slug: 'yerel-seo-rehberi',         kategori: 'local', sure: 13, featured: true,
    tr: { baslik: 'Yerel SEO Rehberi 2026: Google\'da Yerel İşletme Görünürlüğü', ozet: 'Google Local Pack, GBP optimizasyonu ve yerel anahtar kelime stratejisiyle bölgenizde öne çıkın.' },
    en: { baslik: 'Local SEO Guide 2026: Local Business Visibility on Google', ozet: 'Stand out in your area with Google Local Pack, GBP optimization and local keyword strategy.' },
  },
